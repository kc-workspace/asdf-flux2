...
__asdf_bin() {
  ...
  local download_url
  download_url="https://github.com/fluxcd/flux2/releases/download/v{version}/flux_{version}_{os}_{arch}.tar.gz"
  ...
  local checksum_url
  checksum_url="https://github.com/fluxcd/flux2/releases/download/v{version}/flux_{version}_checksums.txt"
